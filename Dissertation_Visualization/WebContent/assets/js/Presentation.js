...
var directory = "assets/data/presentation/";

for (var s = 1; s <= 4; s++) {
	drawTable(directory, "presentation" + s + "R1.csv");
	drawSCPLegend(directory, "presentation" + s + "R2.csv");
	drawPCPLegend(directory, "presentation" + s + "R3.csv");
}