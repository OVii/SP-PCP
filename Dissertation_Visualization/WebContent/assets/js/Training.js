...
var directory = "assets/data/training/";

for (var s = 1; s <= 4; s++) {
	drawTable(directory, "training" + s + "R1.csv");
	drawSCPLegend(directory, "training" + s + "R2.csv");
	drawPCPLegend(directory, "training" + s + "R3.csv");
}